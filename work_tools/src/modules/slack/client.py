...
from modules.slack.config import SlackSettings, get_slack_settings
...
class SlackClient:
    ...
    def __init__(self, settings: SlackSettings | None = None):
        self.settings: SlackSettings = settings or get_slack_settings()
        self._web = WebClient(token=self.settings.bot_token)
