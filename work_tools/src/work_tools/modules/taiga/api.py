...
@click.option(
    "--tasks",
    multiple=True,
    help="Task subjects (repeatable). Use 'subject::description' for bulk mode with descriptions.",
)
@click.option("--tasks-json", default=None, help='JSON array of tasks: \'[{"subject": "...", "description": "..."}]\'')
@click.option("--custom-attrs", multiple=True, help="Custom attributes as 'attr_id::value' (repeatable)")
